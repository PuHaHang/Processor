...
제공 인분은 숫자만 표시해주세요.
요리 과정의 시간은 초 단위로 표시해주세요. 실수 형으로만 표시해주세요.
언급된 재료는 재료 목록에 포함시키며 조리 과정에서는 재료는 {{재료 순번}}으로 표시해주세요. 재료는 겹치지 않아야 합니다.
조리 과정에서 표시된 재료 순번은 재료 목록에 있는 재료 순번과 동일해야 하며 순번을 대괄호로 감싸서 [1], [2], [3] 형식으로 표시해주세요.
  ...
  "stages": [
    {
      ...
      "start_time": "18.559",
      "end_time": "70.320",
      "description": "{1}((1.2kg))에 {2}((적당히))와 {3}((적당히))을 골고루 뿌려 밑간한다. 아주 뜨겁게 달군 팬에 {4}((2큰술))를 두른 후, 밑간한 {1}을 넣고 모든 면이 갈색이 될 때까지 빠르게 지진다. (소고기를 익히는 것이 아니라 표면을 캐러멜화하여 풍미를 더하는 과정이다.)"
    },
    {
      "step": 2,
      "start_time": "70.320",
      "end_time": "97.279",
      "description": "팬에서 꺼낸 뜨거운 {1}의 모든 표면에 {5}((2큰술))를 골고루 바른다. 잠시 그대로 두어 {1}이 식으면서 머스타드의 풍미를 흡수하고 육즙이 재분배되도록 한다."
    },
    {
      "step": 3,
      "start_time": "101.440",
      "end_time": "120.000",
      "description": "믹서에 {6}((700g)), {7}((1쪽)), {2}((적당히)), {3}((적당히))을 넣고 곱게 간다. 여기에 {8}((1큰술))을 손으로 부숴 넣고 다시 한번 가볍게 간다."
    },
    {
      "step": 4,
      "start_time": "141.100",
    ...
    },
    {
      ...
      "start_time": "179.220",
      "end_time": "295.739",
      "description": "랩을 넓게 펼친 후, 그 위에 {10}((200g))을 약간 겹치도록 평평하게 깔아 직사각형 모양을 만든다. {3}((적당히))을 약간 뿌리고, 식힌 둑셀을 {10} 위에 얇게 펴 바른다. 중앙에 {1}을 올리고, {10}으로 {1}을 감싸듯 조심스럽게 감싼다. 랩으로 단단하게 감싸서 원통형 모양을 만든 후, 양 끝을 비틀어 고정한다."
    },
    {
      "step": 6,
      "start_time": "299.059",
    ...
    },
    {
      ...
      "start_time": "311.459",
      "end_time": "365.660",
      "description": "냉장고에서 꺼낸 {1}을 랩에서 벗긴다. 랩을 넓게 깐 후 그 위에 {11}((1작은술))을 올리고, {1}을 {11}으로 감싼다. 이음새와 양 끝을 잘 봉하고 여분의 페이스트리는 잘라낸다. 다시 랩으로 단단하게 감싸서 모양을 고친다.
    },
    {
      "step": 8,
      "start_time": "374.619",
      "end_time": "401.140",
      "description": "냉장고에서 꺼낸 {1}을 랩에서 벗긴 후, {12}((10장))를 골고루 바른다. 칼등으로 페이스트리 표면에 장식용 무늬를 내고, {13}((1장))을 넉넉하게 뿌린다."
    },
    {
      "step": 9,
      "start_time": "401.140",
